...
ds_menu_audio = create_menu_page(
	["MASTER",		menu_element_type.slider,			change_volume,			1,		[0,1], 0],
	["SOUNDS",		menu_element_type.slider,			change_volume,			1,		[0,1], 1],
	["MUSIC",		menu_element_type.slider,			change_volume,			1,		[0,1], 2],
...
ds_menu_graphics = create_menu_page(
	["RESOLUTION",	menu_element_type.shift,			change_resolution,		0,		["640 x 360", "854 x 480", "1280 x 720", "1440 x 900", "1920 x 1080"]],

...
input_revert_p	= keyboard_check_released(global.key_revert);
...
if(inputting){
	...
	switch(ds_[# 1, menu_option[page]]){
		...
		switch (menu_option[page]){
				case 0: if(!audio_is_playing(snd_passo)){ audio_play_sound(snd_passo, 1, false); } break;
				case 1: if(!audio_is_playing(snd_bird)){ audio_play_sound(snd_bird, 1, false); } break;
				case 2: if(!audio_is_playing(snd_senya_itachi)){ audio_play_sound(snd_senya_itachi, 1, false); } break;
		}
